...
<nav class="navbar navbar-toggleable-md fixed-top navbar-light bg-faded container" style="padding: 20px; background:#fff;">
  <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
   <h1 class="navbar-brand mb-0"><a href="http://akcjademokracja.pl"><img src="https://dzialaj.akcjademokracja.pl/images/akcja/logo.svg" style="height: 70px"></a></h1>
...
<ul class="navbar-nav ml-auto mr-1 float-right hidden-xs-up">
...
<div class="container" style="padding:20px; background:#fff; margin-top:75px">
...
FB.api(
    "/315194262257896", {access_token:'104628140213092|s0QxRJeKfpogy5p8eR4wecXpF8o'},
...
<div class="modal fade bd-example-modal-lg" id="wpisModal" tabindex="-1" role="dialog" aria-labelledby="wpisModalShow" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	      <div class="modal-header">
        <h5 class="modal-title" id="wpisModalLabel"><? if ($wpis) { ?><?=$wpis['subject']?><? }; ?></h5>
